...
`Website Name` is the Consignee name shown by Power BI. Each unique company is processed with the captured hover query and a strict Gemini JSON prompt. Missing or unverified contacts remain blank.
